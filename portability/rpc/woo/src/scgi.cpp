...
int
strpair_get_int(strptr_pair_t* pairs, size_t num, const char *name, int def_value) {
	const char *str = strpair_get(pairs, num, name, NULL);
	if (! str) {
		return def_value;
	} else {
...
long
strpair_get_long(strptr_pair_t* pairs, size_t num, const char *name, long def_value) {
	const char *str = strpair_get(pairs, num, name, NULL);
	if (! str) {
		return def_value;
	} else {
